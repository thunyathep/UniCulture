...
class _DetailRewardState extends State<DetailReward> {
  ...
  List<CoinRedeem> listcoinredeem = [];
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              ...
                              Color(0xffE299AA)
                                  .withOpacity(0.5), // End color with opacity
                            ],
                          ),
                        ),
                      ),
                                  ...
                                  widget.items[0].coins!.length == 1
                                      ? Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              CheckCoinType(
                                                idCoinType: widget.items[0]
                                                    .coins![0].idCoinType,
                                              ),
                                              Text(
                                                " X" +
                                                    widget.items[0].coins![0]
                                                        .amount
                                                        .toString(),
                                              ),
                                            ],
